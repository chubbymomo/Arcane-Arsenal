...
def generate_intro_for_character(engine, entity_id):
    ...
    try:
        ...
        intro_prompt = (
            ...
            "- When creating items in the scene, they should be owned by locations or NPCs, NOT the player\n"
            "- DO NOT write narrative about the player picking up, holding, or using items in your intro\n"
            "- Items in the environment should be mentioned as being THERE (on tables, in corners, etc.), "
            "not as being held or used by the player\n"
            "- Let the player CHOOSE to interact with items through action buttons\n"
            "- Example GOOD: 'A weathered journal lies on the reading table'\n"
            "- Example BAD: 'You pick up the journal and begin reading it'\n"
            "\n"
